...
export function getLodop(oOBJECT, oEMBED) {
    ...
    var strCLodopInstallA = "<font color='red' size='4'><center>Web打印服务CLodop未安装启动，点击这里<a href='http://www.c-lodop.com/download.html' target='_self'><u>下载执行安装</u></a></center>";
    var strCLodopInstallB = "<center>（若此前已安装过，可<a href='CLodop.protocol:setup' target='_self'><u>点这里直接再次启动</u></a>）</center>";
    ...
    var strInstallOK = "<center>成功后请刷新本页面或重启浏览器。</center></font>";
    var LODOP;
    try {
        ...
        if (needCLodop() || isLinuxX86 || isLinuxARM) {
            ...
            if (!LODOP) {
                ...
                // alert("点击这里" + <a href='Lodop7_Linux_X86_64.tar.gz' target='_self'>下载安装</a>)
                ...
                // if (CLODOP.CVERSION < "4.1.5.9")              strAlertMessage = strCLodopUpdate;
